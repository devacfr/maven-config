...
The project maven-config is the parent maven pom for all projects and a maven repository containing all libraries used by me (next step, using [Bintray](https://bintray.com/) as distribution manager).
